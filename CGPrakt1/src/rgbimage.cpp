...
bool RGBImage::saveToDisk(const char* Filename)
{
		...
		static unsigned char fileHeader[] = {
			...
			0, 0, 0, 0, // bfSize - r��e der BMP-Datei in Byte
		...
		unsigned char infoHeader[] = {
			...
			0, 0, 0, 0,	// biHeight - H�he der Bitmap in Piel 
			...
			0, 0, 0, 0, // biXPelsPerMeter - Horizontale Aufl�sung in Pixel pro Meter
			0, 0, 0, 0, // biYPelsPerMeter - Vertikale Aufl�sung in Pixel pro Meter
			0, 0, 0, 0, // biClrUsed - Wenn biBitCount=1: 0. biBitCount=4 oder 8: die Anzahl der Eintr�ge der Farbtabelle; 0 bedeutet die maximale Anzahl (2, 16 oder 256).
